...
**狀態**：待外部輸入、EAS iOS / TestFlight、真機、provider 與 native crash evidence 補齊（Emorapy identity 已落入 `mobile/app.json`；iOS Release simulator evidence 已刷新，舊 `com.cj.motherbearcourt` structured evidence 僅作歷史參考）
**Owner**：Mobile / Ops / QA
...
| Release completion audit | 未完成 / iOS simulator 與 Android local evidence 已刷新 | 2026-06-20 帶本機 release env 的正式指令為 `npm --prefix mobile run release:completion:audit -- --release-env-file=release.env.local --json`；在 Emorapy identity 下 `complete=false`、`failures=0`、`passed=16`、`blocked=7`。Android emulator/app/Maestro、native upload 與 iOS Release simulator evidence 已用 `com.emorapy.app` 重新產出；新 iOS simulator pass evidence 為 [App-iOS-Release-Simulator-2026-06-20T14-04-07-291Z.json](../../90-證據與盤點/環境與發版驗證/App-iOS-Release-Simulator-2026-06-20T14-04-07-291Z.json)。`eas_project_id`、`expo_token`、`eas_android_build_artifact`、`ios_release_simulator_evidence`、`android_emulator_runtime_evidence`、`android_app_runtime_evidence`、`android_full_flow_evidence`、`native_imagepicker_upload_evidence`、`sentry_ios_native_prebuild_configuration` 與 `telemetry_runtime_evidence` 已解除；剩餘需補 Apple / ASC 憑證、EAS iOS artifact、TestFlight、physical device、provider delivery 與 native crash runtime |
| iOS Release simulator refresh | 已完成 / Emorapy identity pass evidence | 2026-06-20 已安裝 iOS 26.5 simulator runtime，啟動 iOS 26.5 `iPhone 17` simulator，並以 `SENTRY_DISABLE_AUTO_UPLOAD=true DEVELOPER_DIR=/Applications/Xcode.app/Contents/Developer npm --prefix mobile run ios:release-simulator:smoke -- --device="iPhone 17" --skip-prebuild` 驗證 Expo dependency alignment、Release build、Sentry Xcode phases、`com.emorapy.app` install / launch。runner 產出 pass evidence [App-iOS-Release-Simulator-2026-06-20T14-04-07-291Z.json](../../90-證據與盤點/環境與發版驗證/App-iOS-Release-Simulator-2026-06-20T14-04-07-291Z.json)，且明示不替代 EAS iOS、TestFlight、physical device、provider delivery 或 native crash runtime evidence |
