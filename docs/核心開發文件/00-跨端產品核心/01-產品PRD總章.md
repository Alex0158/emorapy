...
| CJ-PRD-APP-002 | App API / DTO 必須消費 shared contracts / api-client，不長期手寫 App-only DTO | 全主線 | 已作為基線；M1-M5 domain client 已下沉到 `@cj/api-client`，新增契約仍需按 Parity / API governance 回寫 |
