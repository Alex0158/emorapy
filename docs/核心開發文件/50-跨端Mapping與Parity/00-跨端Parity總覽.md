...
| 先聊再判 | Backend/DB Production `a685db36` 已有 channel、context policy、capsule、exact approval、participant stream、handoff及 migration/backfill evidence | Web Production `a685db36` 已有 private/shared lane、preference、capsule與 exact review/approval | 可治理相關風險與成本 | App M3 code baseline已接 shared contracts、lane、capsule、approval與 handoff；native release-blocked | Web/Backend Production containment已部署；雙身份真服務、per-owner compiler、Safety Router、native lifecycle/replay與 App M6 evidence仍是 P0 parity gap |
