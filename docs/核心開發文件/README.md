...
**文檔版本**：v2.1  
**最後更新**：2026-04-05  
**對應發佈**：v1.3.4（Repair Journey 2.3：角色感知、deferred 回應與通知 snooze）  
...
- `AI流式驗收對照-2026-04-04.md`（按 `方案.md` 逐條驗收的 AI 流式專項對照）
- `Repair Journey 2.3 場景驗收矩陣.md`（按角色 / 入口 / 狀態 / CTA / 落點驗收 F05/F13 再進場閉環）
- `Repair Journey 2.3 真庫同步記錄-2026-04-05.md`（本地 `.env` 指向資料庫的 schema 收口與核驗記錄）
- `Staging 運行時收口記錄-2026-04-05.md`（Railway staging 啟動、Redis/metrics 收口、CORS 與公開/機器端點邊界的實況記錄）
- `維護規範.md`
- `文檔封板後-代碼與測試對齊清單.md`
