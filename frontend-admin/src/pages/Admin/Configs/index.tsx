  ...
  return (
    <Space orientation="vertical" size="large" style={{ width: '100%' }}>
      ...
      {(listQuery.error || runtimeQuery.error) && (
        <Alert showIcon type="error" title={t('admin.configs.loadFailed')} />
      )}
      {!canWriteConfigs && (
        <Alert showIcon type="warning" title={t('admin.configs.writeDenied')} />
      )}
      ...
      <Card title={t('admin.configs.upsert')}>
        ...
        >
          ...
          <Space>
            <Form.Item
              label={t('admin.configs.isRuntime')}
              name="isRuntime"
            ...
            <Form.Item
              label={t('admin.configs.isSensitive')}
              name="isSensitive"
              valuePropName="checked"
            >
              <Switch disabled={!canWriteConfigs} />
