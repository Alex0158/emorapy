...
6. 外部 status / handoff 的最新 canonical 索引為 `App-External-Evidence-Status-2026-06-20T08-26-33-325Z.json` 與 `App-External-Evidence-Handoff-2026-06-20T08-26-36-806Z.json`；它們只固定 owner 交接、env-file provenance 與 normalized blocker，不解除 M6 strict blocker。
