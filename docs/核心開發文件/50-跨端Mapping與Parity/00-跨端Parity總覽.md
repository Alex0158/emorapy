...
| M6 Release Hardening | iOS TestFlight、EAS Update、Android readiness、evidence | release gate、version、telemetry、App evidence | Release-blocked；release preflight、readiness、evidence verifier、handoff / prerequisite / workflow / env / redaction gates 可作工程基線，EAS project id、Expo token、Android native toolchain、EAS Android artifact、Android emulator / app / Maestro 與 native ImagePicker evidence 已具備；完整 sign-off 仍缺 Apple / ASC credentials、EAS iOS artifact、TestFlight、Emorapy identity 下 iOS Release simulator evidence refresh、physical device、push delivery 與 native crash runtime evidence |
