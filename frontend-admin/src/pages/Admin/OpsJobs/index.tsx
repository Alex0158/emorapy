        ...
        {accessViewState.showPageTokenInvalid ? (
          <AnimatedWrapper animation="slide" direction="up" delay={170}>
            <Alert
              ...
              showIcon
              type="error"
              title={t('admin.ops.invalidTokenFormat')}
            />
          </AnimatedWrapper>
        ) : (
          accessViewState.showPageTokenRequired && (
            <AnimatedWrapper animation="slide" direction="up" delay={170}>
              <Alert
                ...
                showIcon
                type="warning"
                title={t('admin.ops.tokenRequired')}
              />
            </AnimatedWrapper>
          )
        )}
        ...
        {accessViewState.showVerifyingAccess && (
          <AnimatedWrapper animation="slide" direction="up" delay={175}>
            <Alert
              ...
              showIcon
              type="info"
              title={t('admin.ops.verifyingAccess')}
            />
          </AnimatedWrapper>
        )}
        ...
        {dataViewState.showSampledHint && (
          <AnimatedWrapper animation="slide" direction="up" delay={190}>
            <Alert
              ...
              showIcon
              type="info"
              title={t('admin.ops.sampledHint').replace(
                '{rows}',
            ...
            <div style={{ marginTop: 16 }}>
              ...
              <Row gutter={[16, 16]} style={{ marginTop: 8 }}>
                ...
                <Col xs={24} sm={12} md={8} lg={6}>
                  <Card>
                    <Statistic
                      title={t('admin.ops.successRuns')}
                      value={totals.successRuns}
                    />
                  </Card>
                </Col>
                <Col xs={24} sm={12} md={8} lg={6}>
