...
6. 若本次改動改變架構取捨、共享層、信任邊界、DB/API/shared/App adapter 或 release gate，讀 [02-架構決策與ADR治理基線.md](./02-架構決策與ADR治理基線.md)
7. 若本次改動涉及 schema migration、backfill、DB parity、棄用、shared contract compatibility 或 release-blocking migration，讀 [03-資料模型SchemaMigration與相容性治理基線.md](./03-資料模型SchemaMigration與相容性治理基線.md)
8. 若本次改動涉及 App 端，補讀 [../20-App端/01-App導航與平台Adapter基線.md](../20-App端/01-App導航與平台Adapter基線.md) 與 [../50-跨端Mapping與Parity/01-App首輪能力與工程落點Mapping.md](../50-跨端Mapping與Parity/01-App首輪能力與工程落點Mapping.md)
