...
5. [../20-App端/00-App端總覽.md](../20-App端/00-App端總覽.md)
6. [../20-App端/01-App導航與平台Adapter基線.md](../20-App端/01-App導航與平台Adapter基線.md)
...
5. App navigation / platform adapter 的具體落點由 `20-App端/01-App導航與平台Adapter基線.md` 裁決；本目錄只追蹤它對 Backend / API / DB / shared package 與跨端一致性的影響。
6. App 測試、回歸、CI 或證據入口只在 `08-測試規範與驗收/03-App測試與證據接入基線.md` 的進場條件滿足後承認為有效 Parity 證據。
