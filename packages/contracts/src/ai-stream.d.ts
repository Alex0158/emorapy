export type AIStreamScopeType = 'interview_session' | 'chat_room' | 'case_judgment' | 'judgment_detail' | 'generic_ai_task';
...
export type AIStreamPhase = 'thinking' | 'collecting_context' | 'analyzing_emotion' | 'building_responsibility' | 'drafting_judgment' | 'finalizing' | 'safety_alert' | 'completed' | (string & {});
...
//# sourceMappingURL=ai-stream.d.ts.map