...
| 先聊再判 | Backend/DB containment 功能基準 `a685db36` 已有 channel、context policy、capsule、exact approval、participant stream、handoff及 migration/backfill evidence；目前 exact Production `8e93680` | Web 同一 Production 基準已有 private/shared lane、preference、capsule與 exact review/approval | 可治理相關風險與成本 | App M3 code baseline已接 shared contracts、lane、capsule、approval與 handoff；native release-blocked | per-owner compiler、雙層 consent、Safety Router 與 trust/safety surface 已在 local candidate 接線；exact-main/Production、雙身份真服務、native lifecycle/replay與 App M6 evidence仍是 parity gap |
...
| M3 Chat | room、invite、private/shared channel、participant-scoped stream、capsule、versioned request approval、handoff | F07 / F04、chat / AI stream / judgment/repair context routes | Web/Backend Production containment deployed @ `a685db36`；App code已接 channels、lanes、preference、capsule、exact review、雙方 approval、submit與 handoff，但 native release-blocked。雙身份真服務、native replay/lifecycle、per-owner controls與 M6 evidence未完成 |
