...
export function normalizeAdminJobStatsQuery(query: AdminJobStatsQuery = {}): AdminJobStatsQuery {
...
export function updateAdminJobStatsDays(
  ...
  return normalizeAdminJobStatsQueryWithDefaults({
    ...query,
    days:
      typeof value === 'number' ? value : DEFAULT_ADMIN_JOB_STATS_QUERY.days,
  });
}
