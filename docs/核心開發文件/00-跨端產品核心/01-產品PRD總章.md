...
| --- | --- | --- | --- |
| CJ-PRD-APP-001 | Expo React Native + TypeScript、iOS-first / Android-compatible、單一 `mobile/` codebase | 全主線 | 已落地；`mobile/` 已完成 Expo RN runtime、iOS simulator / Android emulator / Android release APK evidence，仍待 EAS/TestFlight / physical device sign-off |
| CJ-PRD-APP-002 | App API / DTO 必須消費 shared contracts / api-client，不長期手寫 App-only DTO | 全主線 | 已落地；M1-M5 domain client 已下沉到 `@cj/api-client`，新增契約仍需按 Parity / API governance 回寫 |
| CJ-PRD-APP-003 | App navigation skeleton 必須替換 Expo template，並按 App route group 承接功能 | 全主線 | 已落地；Expo template tabs 已移除，route topology / Maestro selector / web route smoke gate 已固定 |
| CJ-PRD-APP-004 | Token、anonymous session、device metadata 必須經 SecureStore / platform storage adapter | 快速判斷、正式處理、先聊再判 | 已落地；auth/session bootstrap、logout cleanup、token rotation revoke 與 platform boundary gate 已建立，physical device evidence 歸入 M6 |
| CJ-PRD-APP-005 | App 必須優先承接 Quick flow、result replay、claim-session handoff | CJ-PRD-COM-001 | 已落地；Quick/Auth/result/claim-session、stream replay、expired anonymous session recovery 與 local true-service smoke 已通過，release 級真機證據仍待 M6 |
| CJ-PRD-APP-006 | App 應承接 Profile / Interview / My Story，並支援 SSE 中斷恢復 | CJ-PRD-COM-004 | 已落地；Profile / Interview / My Story、AI stream recovery、failed / partial-success UI 與 deep true-service smoke 已通過，native lifecycle evidence 歸入 M6 |
| CJ-PRD-APP-007 | App 應承接 Chat room、invite、message stream、request judgment 與 handoff | CJ-PRD-COM-003 | 已落地；Chat room / invite / message / request judgment / auth resume 已接線並通過 local true-service smoke，真 push invite landing 歸入 M6 |
| CJ-PRD-APP-008 | App 應分階段承接 Formal Case、Judgment、Repair Journey、Execution | CJ-PRD-COM-002 | 已落地；Formal Case / Repair / evidence upload / repair replan stream / DB-backed replay 已通過 local true-service smoke，repair 全狀態與真機 selected-media evidence 仍待補 |
...
| CJ-PRD-APP-010 | Native upload 必須經 platform upload adapter，不在 App 本地裁決 media 授權 | CJ-PRD-COM-002 / CJ-PRD-COM-004 | 部分實作；platform upload adapter、Case safety assertion、picker-cancel evidence 與 selected-media backend upload evidence 已建立，真機 picker-selected asset / profile media evidence 仍待 M6 |
| CJ-PRD-APP-011 | App telemetry 只回傳必要 safe context，不承接 Admin Web | CJ-PRD-COM-005 | 部分實作；safe telemetry / OTLP / Admin report / 30d cleanup / telemetry runtime pass evidence 已完成；native crash runtime、external tracing backend、長期 crash-free / SLO baseline 仍不得宣稱完成 |
