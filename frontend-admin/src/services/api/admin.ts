...
export const adminApi = {
	...
	async listJobs(): Promise<{ jobs: AdminJobListItem[] }> {
		const response = await request.get<
			ApiResponse<{ jobs: AdminJobListItem[] }>
		>("/admin/jobs", {
			headers: getAdminAuthHeaders(),
		});
	...
	async listConfigs(params?: {
		...
		const response = await request.get<
			ApiResponse<AdminListResponse<AdminConfigItem>>
		>("/admin/configs", {
			params,
			headers: getAdminAuthHeaders(),
		});
		return (response.data as ApiResponse<AdminListResponse<AdminConfigItem>>)
			.data;
	},
	...
	async listUsers(params?: {
		...
		const response = await request.get<
			ApiResponse<AdminListResponse<AdminAppUserItem>>
		>("/admin/users", {
			params,
			headers: getAdminAuthHeaders(),
		});
		return (response.data as ApiResponse<AdminListResponse<AdminAppUserItem>>)
			.data;
	},
	...
	async updateUserStatus(
		...
		const response = await request.patch<
			ApiResponse<{ user: AdminAppUserItem }>
	...
	async listAuditLogs(params?: {
		...
		const response = await request.get<
			ApiResponse<AdminListResponse<AdminAuditLogItem>>
		>("/admin/audit-logs", {
			params,
			headers: getAdminAuthHeaders(),
		});
		return (response.data as ApiResponse<AdminListResponse<AdminAuditLogItem>>)
			.data;
	},
	...
	async listReportAIStreamSessions(params?: {
		...
		const response = await request.get<
			ApiResponse<AdminAIStreamSessionListData>
	...
	async listMediaProviders(params?: {
		...
		const response = await request.get<
			ApiResponse<{ items: AdminMediaProviderCatalogItem[] }>
		>("/providers", { params, headers: getAdminAuthHeaders() });
		return (
			response.data as ApiResponse<{ items: AdminMediaProviderCatalogItem[] }>
		).data;
	},
	...
	async estimateMediaProviderCost(
		...
		const response = await request.post<
			ApiResponse<AdminMediaProviderCostEstimate>
		>(`/providers/${providerKey}/estimate`, payload, {
			headers: getAdminAuthHeaders(),
		});
	...
	async testMediaProvider(
		...
		const response = await request.post<
			ApiResponse<AdminMediaProviderTestResult>
		>(`/providers/${providerKey}/test`, payload, {
			headers: getAdminAuthHeaders(),
		});
	...
	async generateMediaProviderImage(
		...
		const response = await request.post<
			ApiResponse<AdminMediaProviderGenerationResult>
		>(`/providers/${providerKey}/images`, payload, {
			headers: getAdminAuthHeaders(),
		});
		return (response.data as ApiResponse<AdminMediaProviderGenerationResult>)
			.data;
	},
	...
	async generateMediaProviderVideo(
		...
		const response = await request.post<
			ApiResponse<AdminMediaProviderGenerationResult>
		>(`/providers/${providerKey}/videos`, payload, {
			headers: getAdminAuthHeaders(),
		});
		return (response.data as ApiResponse<AdminMediaProviderGenerationResult>)
			.data;
	...
	async getCustomReport(
		...
		return (response.data as ApiResponse<{ metrics: Record<string, number> }>)
			.data;
	},
	...
	async getInterviewRuntimeConfig(): Promise<AdminInterviewRuntimeConfigData> {
		const response = await request.get<
			ApiResponse<AdminInterviewRuntimeConfigData>
	...
	async listAdminUsers(params?: {
		...
		const response = await request.get<
			ApiResponse<AdminListResponse<AdminAdminUserItem>>
		>("/admin/admin-users", {
			params,
			headers: getAdminAuthHeaders(),
		});
		return (response.data as ApiResponse<AdminListResponse<AdminAdminUserItem>>)
			.data;
	},
	...
	async createAdminUser(payload: {
		...
		const response = await request.post<
			ApiResponse<{ item: AdminAdminUserItem }>
		>("/admin/admin-users", payload, {
			headers: getAdminAuthHeaders(),
		});
	...
	async updateAdminUser(
		...
		const response = await request.patch<
			ApiResponse<{ item: AdminAdminUserItem }>
		>(`/admin/admin-users/${adminUserId}`, payload, {
			headers: getAdminAuthHeaders(),
		});
		return (response.data as ApiResponse<{ item: AdminAdminUserItem }>).data;
	},
	...
	async deleteAdminUser(
		...
		const response = await request.delete<
			ApiResponse<{ item: AdminAdminUserItem }>
		>(`/admin/admin-users/${adminUserId}`, { headers: getAdminAuthHeaders() });
		return (response.data as ApiResponse<{ item: AdminAdminUserItem }>).data;
	},
};
