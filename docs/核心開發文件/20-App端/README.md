...
4. `mobile/app` 的 Emorapy route group 與 M0-M5 screen 已可作 M0-M5 普通用戶 App flow 入口；是否可宣稱完整完成，仍以 Roadmap 的 native / external evidence 與 M6 strict release sign-off 為準。
