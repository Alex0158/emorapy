...
| Migration history | `backend/prisma/migrations/*/migration.sql` 與 `migration_lock.toml` 已存在，含 raw SQL index / trigger / additive schema；App Push 已新增 `20260508093000_add_push_device_tokens`、`20260508113000_add_push_receipt_tracking`；App telemetry 已新增 `20260508124000_add_app_telemetry_events`；AI stream persistence 已新增 `20260508133000_add_ai_stream_persistence`；M2 Interview facts 已新增 `20260508143000_add_interview_collected_facts`、`20260508143500_add_interview_turn_extracted_facts` | 已有 migration history；缺統一破壞性變更分類 |
