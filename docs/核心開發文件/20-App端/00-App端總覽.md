...
| Blocker | 意義 |
| --- | --- |
| `eas_project_id`、`expo_token` | EAS project / token 尚未滿足正式 release runner 要求 |
...
| `android_native_toolchain_evidence` | Android SDK root、adb、emulator、sdkmanager 等 native build / emulator toolchain 尚未滿足 release audit |
| `eas_android_build_artifact` | Android EAS production build structured pass evidence 尚未完成 |
