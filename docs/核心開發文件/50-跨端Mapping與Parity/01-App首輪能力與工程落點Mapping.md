...
| Release-blocked | 本地 App 工程與驗收入口已落地，但完整完成仍受 EAS / TestFlight / 真機 / provider / native crash 等外部 evidence 阻擋；release DB parity 與 telemetry runtime 依當前 audit 可各自為 passed 或 blocked |
